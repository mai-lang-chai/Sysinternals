...
![image](https://github.com/mai-lang-chai/MicrosoftTools/blob/master/pic/access-D.jpg)  
也可以查看注册表的读写的和deny权限  
![image](https://github.com/mai-lang-chai/MicrosoftTools/blob/master/pic/access-R.jpg)  
## Autologon - 自动登录 ##
...
![image](https://github.com/mai-lang-chai/MicrosoftTools/blob/master/pic/autologon.jpg)   
感觉卵用不大  
## Autoruns ##
右键进程可以跳转到目录和注册表，还可以一键上传到VirTotal,也可以配合Process Explorer高效组合  
![image](https://github.com/mai-lang-chai/MicrosoftTools/blob/master/pic/autoruns.jpg)   
可以查看所有用户，和查看指定用户的进程  
![image](https://github.com/mai-lang-chai/MicrosoftTools/blob/master/pic/autoruns2.jpg)   
## Bginfo ##
嵌入式将以下信息的镶在桌面上  
